...
const projects = [
  {
    title: "Prime Wedding Cars",
    description:
      "The Car Rental project is a comprehensive MERN stack web application tailored for small rental companies. It encompasses end-to-end functionality, including user authentication, booking management, and admin features. This application is built using Node.",
    cloneLink: "https://autanaslub.pl/",
    repoLink: "https://autanaslub.pl/",
    languages: [
      {
        name: "JavaScript",
        percentage: "99.5%",
        url: "https://autanaslub.pl/",
      },
      {
        name: "other",
        percentage: "0.5%",
